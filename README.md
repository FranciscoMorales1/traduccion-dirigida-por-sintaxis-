...
[https://graphviz.org/download/#windows](https://graphviz.org/download/#windows)
...
✔ Se implementó satisfactoriamente un EDTS completo
✔ El AST decorado permite visualizar semántica
✔ El parser respeta precedencia y asociatividad
✔ Se manejan errores sintácticos y semánticos
✔ La Tabla de Símbolos gestiona identificadores
✔ Proyecto cumple todos los requisitos académicos
